...
func notify_mouse_enter_control(control: Control) -> void:
	_hovering_controls[control] = true

func notify_mouse_exit_control(control: Control) -> void:
	_hovering_controls.erase(control)
...
func _is_hovering_on_any() -> bool:
	return _hovering_pickable.get_node() != null or _hovering_controls.size() > 0
